...
export const researchSources = [
  {
    ...
    apa: "Bakshy, E., Messing, S., & Adamic, L. A. (2015). Exposure to ideologically diverse news and opinion on Facebook. Science, 348(6239), 1130-1132.",
  ...
  },
  {
    ...
    apa: "Baumann, F., Arora, N., Rahwan, I., & Czaplicka, A. (2025). Dynamics of algorithmic content amplification on TikTok [Preprint]. arXiv.",
  ...
  },
  {
    ...
    apa: "Boeker, M., & Urman, A. (2022). An empirical investigation of personalization factors on TikTok [Preprint]. arXiv.",
  ...
  },
  {
    ...
    apa: "Boerman, S. C., Willemsen, L. M., & Van Der Aa, E. P. (2017). This post is sponsored: Effects of sponsorship disclosure on persuasion knowledge and electronic word of mouth in the context of Facebook. Journal of Interactive Marketing, 38, 82-92.",
  ...
  },
  {
    ...
    apa: "Fazio, L. K., Brashier, N. M., Payne, B. K., & Marsh, E. J. (2015). Knowledge does not protect against illusory truth. Journal of Experimental Psychology: General, 144(5), 993-1002.",
  ...
  },
  {
    ...
    apa: "Friestad, M., & Wright, P. (1994). The persuasion knowledge model: How people cope with persuasion attempts. Journal of Consumer Research, 21(1), 1-31.",
  ...
  },
  {
    ...
    apa: "Kaplan, L., Patel, D., Gerzon, N., Mislove, A., & Sapiezynski, P. (2026). When For You isn't for you: Measuring user agency in TikTok's algorithmic feed [Preprint]. arXiv.",
  ...
  },
  {
    ...
    apa: "Lyngs, U., Lukoff, K., Slovak, P., Binns, R., Slack, A., Inzlicht, M., Van Kleek, M., & Shadbolt, N. (2019). Self-control in cyberspace: Applying dual systems theory to a review of digital self-control tools. Proceedings of the 2019 CHI Conference on Human Factors in Computing Systems.",
  ...
  },
  {
    ...
    apa: "Magdy, W., Mubarak, H., & Salminen, J. (2025). Who should set the standards? Analysing censored Arabic content on Facebook during the Palestine-Israel conflict [Preprint]. arXiv.",
  ...
  },
  {
    ...
    apa: "Mathur, A., Narayanan, A., & Chetty, M. (2018). Endorsements on social media: An empirical study of affiliate marketing disclosures on YouTube and Pinterest. Proceedings of the ACM on Human-Computer Interaction, 2(CSCW), Article 119.",
  ...
  },
  {
    ...
    apa: "Piccardi, T., Saveski, M., Jia, C., Hancock, J. T., Tsai, J. L., & Bernstein, M. S. (2024). Social media algorithms can shape affective polarization via exposure to antidemocratic attitudes and partisan animosity [Preprint]. arXiv.",
  ...
  },
  {
    ...
    apa: "Rozendaal, E., Lapierre, M. A., van Reijmersdal, E. A., & Buijzen, M. (2011). Reconsidering advertising literacy as a defense against advertising effects. Journal of Advertising, 40(1), 83-94.",
  ...
  },
  {
    ...
    apa: "Vera, J. A., & Ghosh, S. (2025). They've over-emphasized that one search: Controlling unwanted content on TikTok's For You Page [Preprint]. arXiv.",
